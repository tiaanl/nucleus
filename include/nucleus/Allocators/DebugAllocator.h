...
public:
  ...
  Allocator* getParent() const { return m_parent; }

  USize getBytesAllocated() const { return m_bytesAllocated; }
  USize getBytesDeallocated() const { return m_bytesAllocated - m_bytesOutstanding; }
  USize getBytesOutstanding() const { return m_bytesOutstanding; }
  USize getMaxAllocated() const { return m_maxAllocated; }
  USize getBlocksOutstanding() const { return m_blocks.size(); }

  static USize getLeakedBytes() { return s_leakedBytes; }
  static USize getLeakedBlocks() { return s_leakedBlocks; }
...
protected:
  ...
  bool doIsEqual(const Allocator& other) const noexcept override { return this == &other; }
